...
const FOES = {
  rat:      { name:'Ratte',    nameEn:'Rat',             icon:'🐀', sprite:'rat',      hp:8,  atk:2,  def:0,  xp:5,   gold:[1,3],   status:null },
  slime:    { name:'Schleim', nameEn:'Slime',           icon:'🫧', sprite:'slime',    hp:14, atk:4,  def:1,  xp:10,  gold:[1,5],   status:null },
  goblin:   { name:'Goblin',   nameEn:'Goblin',         icon:'👺', sprite:'goblin',   hp:22, atk:7,  def:2,  xp:18,  gold:[3,10],  status:{type:'stun',   chance:.25,turns:1,value:0} },
  bat:      { name:'Fledermaus',nameEn:'Bat',           icon:'🦇', sprite:'bat',     hp:18, atk:8,  def:1,  xp:16,  gold:[2,7],   status:null },
  wolf:     { name:'Wolf',     nameEn:'Wolf',           icon:'🐺', sprite:'wolf',     hp:28, atk:9,  def:2,  xp:24,  gold:[2,8],   status:null },
  troll:    { name:'Troll',    nameEn:'Troll',          icon:'👹', sprite:'troll',    hp:45, atk:12, def:5,  xp:40,  gold:[8,18],  status:null },
  skeleton: { name:'Skelett',  nameEn:'Skeleton',       icon:'💀', sprite:'skeleton', hp:38, atk:11, def:4,  xp:35,  gold:[5,15],  status:null,                                          element:'undead', weakTo:'light' },
  zombie:   { name:'Zombie',   nameEn:'Zombie',         icon:'🧟', sprite:'zombie',   hp:50, atk:13, def:3,  xp:45,  gold:[6,16],  status:{type:'poison', chance:.35,turns:3,value:6},   element:'undead', weakTo:'light' },
  ghost:    { name:'Geist',    nameEn:'Ghost',          icon:'👻', sprite:'ghost',    hp:42, atk:15, def:6,  xp:55,  gold:[8,20],  status:{type:'stun',   chance:.20,turns:1,value:0},   element:'undead', weakTo:'light' },
  demon:    { name:'Dämon',    nameEn:'Demon',          icon:'😈', sprite:'demon',    hp:70, atk:18, def:7,  xp:90,  gold:[15,40], status:{type:'burn',   chance:.30,turns:2,value:10},  element:'fire',   weakTo:'ice'   },
  dragon:         { name:'Drache',          nameEn:'Dragon',         icon:'🐉', sprite:'dragon',         hp:90,  atk:20, def:8,  xp:120, gold:[25,70],  status:{type:'burn',chance:.40,turns:3,value:12},  element:'fire', weakTo:'ice' },
  fire_elemental: { name:'Feuer-Elementar', nameEn:'Fire Elemental', icon:'🔥', sprite:'fire_elemental', hp:130, atk:28, def:10, xp:170, gold:[22,55],  status:{type:'burn',chance:.50,turns:2,value:12},  element:'fire', weakTo:'ice' },
  lava_golem:     { name:'Lava-Golem',      nameEn:'Lava Golem',     icon:'🌋', sprite:'lava_golem',     hp:180, atk:32, def:15, xp:230, gold:[32,80],  status:{type:'burn',chance:.40,turns:3,value:15},  element:'fire', weakTo:'ice' },
  phoenix:        { name:'Phönix',          nameEn:'Phoenix',        icon:'🦅', sprite:'phoenix',        hp:145, atk:35, def:8,  xp:210, gold:[28,68],  status:{type:'burn',chance:.45,turns:2,value:14},  element:'fire', weakTo:'ice' },
  void_shade:     { name:'Leerenschatten',  nameEn:'Void Shade',     icon:'🌑', sprite:'void_shade',     hp:165, atk:42, def:12, xp:290, gold:[42,105], status:{type:'stun',chance:.30,turns:1,value:0},   element:'void', weakTo:'light' },
  shadow_spider:  { name:'Schattenspinne',  nameEn:'Shadow Spider',  icon:'🕷', sprite:'shadow_spider',  hp:195, atk:48, def:14, xp:340, gold:[55,130], status:{type:'poison',chance:.50,turns:4,value:18}, element:'void', weakTo:'light' },
  chaos_dragon:   { name:'Chaos-Drache',    nameEn:'Chaos Dragon',   icon:'🐲', sprite:'chaos_dragon',   hp:260, atk:58, def:18, xp:480, gold:[85,210], status:{type:'burn',chance:.50,turns:3,value:22},  element:'void', weakTo:'light' },
  sea_serpent:    { name:'Seeschlange',      nameEn:'Sea Serpent',    icon:'🐍', sprite:'sea_serpent',    hp:320, atk:68, def:22, xp:600, gold:[100,260],status:{type:'poison',chance:.40,turns:3,value:25}, element:'water',weakTo:'lightning' },
  coral_crab:     { name:'Korallen-Krabbe', nameEn:'Coral Crab',     icon:'🦀', sprite:'coral_crab',     hp:380, atk:72, def:28, xp:680, gold:[115,290],status:{type:'stun',chance:.25,turns:1,value:0},   element:'water',weakTo:'lightning' },
  deep_kraken:    { name:'Tiefen-Kraken',   nameEn:'Deep Kraken',    icon:'🦑', sprite:'deep_kraken',    hp:460, atk:82, def:24, xp:820, gold:[145,380],status:{type:'stun',chance:.35,turns:2,value:0},   element:'water',weakTo:'lightning' },
  storm_hawk:     { name:'Sturmfalke',       nameEn:'Storm Hawk',     icon:'🦅', sprite:'storm_hawk',     hp:440, atk:90, def:20, xp:850, gold:[140,360],status:{type:'stun',chance:.30,turns:1,value:0},   element:'air',  weakTo:'earth' },
  wind_giant:     { name:'Windriese',        nameEn:'Wind Giant',     icon:'💨', sprite:'wind_giant',     hp:540, atk:98, def:30, xp:1000,gold:[180,460],status:null,                                        element:'air',  weakTo:'earth' },
  thunder_wyrm:   { name:'Donnerwurm',       nameEn:'Thunder Wyrm',   icon:'⚡', sprite:'thunder_wyrm',   hp:620, atk:110,def:26, xp:1200,gold:[220,580],status:{type:'burn',chance:.45,turns:3,value:30},  element:'lightning',weakTo:'earth' },
  ice_golem:      { name:'Eis-Golem',        nameEn:'Ice Golem',      icon:'🧊', sprite:'ice_golem',      hp:700, atk:120,def:40, xp:1400,gold:[280,720],status:{type:'stun',chance:.30,turns:1,value:0},   element:'ice',  weakTo:'fire' },
  frost_troll:    { name:'Frost-Troll',      nameEn:'Frost Troll',    icon:'❄', sprite:'frost_troll',    hp:820, atk:130,def:35, xp:1600,gold:[320,850],status:{type:'poison',chance:.35,turns:3,value:40}, element:'ice',  weakTo:'fire' },
  blizzard_dragon:{ name:'Blizzard-Drache',  nameEn:'Blizzard Dragon',icon:'🌨', sprite:'blizzard_dragon',hp:1000,atk:150,def:45, xp:2000,gold:[450,1200],status:{type:'burn',chance:.50,turns:4,value:45},  element:'ice',  weakTo:'fire' },
  // NEW ENEMIES
  mushroom_man: { name:'Pilzmann',    nameEn:'Mushroom Man',       icon:'🍄', sprite:'mushroom_man', hp:20, atk:5,  def:1,  xp:14,  gold:[2,7],   status:{type:'poison',chance:.30,turns:2,value:4},  element:'nature' },
  dire_wolf:    { name:'Fürchterlicher Wolf',nameEn:'Dire Wolf',   icon:'🐺', sprite:'wolf', palette:['#555555','#222222','#888888','#111111','#dd2222','#cccccc'], hp:38, atk:13, def:3,  xp:30,  gold:[4,12],  status:null },
  giant_spider: { name:'Riesenspinne',nameEn:'Giant Spider',       icon:'🕷', sprite:'shadow_spider', palette:['#226600','#113300','#449922','#111111','#88ff44','#aabbaa'], hp:30, atk:10, def:2,  xp:28,  gold:[3,10],  status:{type:'poison',chance:.40,turns:2,value:5}, element:'nature' },
  lizardman:    { name:'Eidechsenmann',nameEn:'Lizardman',         icon:'🦎', sprite:'goblin', palette:['#336633','#224422','#aabb88','#cc5522','#888844','#556633','#ddcc66','#111111'], hp:35, atk:11, def:4,  xp:32,  gold:[5,14],  status:null },
  dark_mage:    { name:'Dunkler Magier',nameEn:'Dark Mage',        icon:'🧙', sprite:'dark_mage', hp:48, atk:16, def:2,  xp:55,  gold:[10,28],  status:{type:'burn',chance:.35,turns:2,value:8},   element:'void' },
  vampire:      { name:'Vampir',      nameEn:'Vampire',            icon:'🧛', sprite:'vampire', hp:55, atk:17, def:5,  xp:65,  gold:[12,32],  status:{type:'poison',chance:.25,turns:3,value:7},  element:'undead', weakTo:'light' },
  wraith:       { name:'Schatten-Wraith',nameEn:'Wraith',          icon:'👻', sprite:'ghost', palette:['#8855cc','#5522aa','#bb88ff','#222222','#cc44ff','#ffffff'], hp:58, atk:20, def:8,  xp:75,  gold:[14,38],  status:{type:'stun',chance:.30,turns:1,value:0}, element:'undead', weakTo:'light' },
  corrupted_knight:{ name:'Verderbter Ritter',nameEn:'Corrupted Knight',icon:'⚔', sprite:'skeleton', palette:['#444466','#2222aa','#6666cc','#111133','#8888dd'], hp:80, atk:22, def:12, xp:100, gold:[20,60],  status:{type:'stun',chance:.20,turns:1,value:0} },
  dark_sorcerer:{ name:'Dunkler Zauberer',nameEn:'Dark Sorcerer',  icon:'🔮', sprite:'dark_mage', palette:['#c8b0a0','#111111','#1a0030','#3a0060','#ffaa00','#ff44aa','#2a0a00'], hp:72, atk:25, def:6,  xp:110, gold:[22,55],  status:{type:'burn',chance:.45,turns:2,value:12}, element:'void' },
  magma_titan:  { name:'Magma-Titan', nameEn:'Magma Titan',        icon:'🌋', sprite:'lava_golem', palette:['#cc2200','#881100','#ff6600','#ffaa00','#ff4400','#440000'], hp:220, atk:38, def:18, xp:280, gold:[40,100], status:{type:'burn',chance:.50,turns:3,value:18}, element:'fire', weakTo:'ice' },
  void_lich:    { name:'Leeren-Lich', nameEn:'Void Lich',          icon:'💀', sprite:'void_lich', hp:200, atk:55, def:14, xp:380, gold:[65,160], status:{type:'poison',chance:.45,turns:3,value:22}, element:'void', weakTo:'light' },
  glacial_spirit:{ name:'Eisgeist',   nameEn:'Glacial Spirit',     icon:'❄', sprite:'ghost', palette:['#aaddff','#6699cc','#ddeeff','#222244','#aaccff','#ffffff'], hp:780, atk:125,def:36, xp:1450,gold:[290,740], status:{type:'stun',chance:.35,turns:1,value:0}, element:'ice', weakTo:'fire' },
};
...
const ITEMS = {
  wood_sword:  { name:'Wood Sword',   nameEn:'Wooden Sword',    icon:'🗡', slot:'weapon', atk:4,  def:0,             value:10,  buyable:true,  rarity:'common'    },
  iron_sword:  { name:'Iron Sword',   nameEn:'Iron Sword',      icon:'⚔', slot:'weapon', atk:10, def:0,             value:55,  buyable:true,  rarity:'uncommon'  },
  magic_staff: { name:'Magic Staff',  nameEn:'Magic Staff',     icon:'🪄', slot:'weapon', atk:7,  def:0,  maxMp:10,  value:65,  buyable:true,  rarity:'rare'      },
  dragon_blade:{ name:'Dragon Blade', nameEn:'Dragon Blade',    icon:'🔥', slot:'weapon', atk:22, def:0,             value:350, buyable:false, rarity:'legendary' },
  leather:     { name:'Leather',      nameEn:'Leather Armor',   icon:'🥋', slot:'armor',  atk:0,  def:4,             value:30,  buyable:true,  rarity:'common'    },
  iron_shield: { name:'Iron Shield',  nameEn:'Iron Shield',     icon:'🛡', slot:'armor',  atk:0,  def:9,             value:85,  buyable:true,  rarity:'uncommon'  },
  demon_armor: { name:'Demon Armor',  nameEn:'Demon Armor',     icon:'🔴', slot:'armor',  atk:2,  def:14,            value:220, buyable:false, rarity:'epic'      },
  health_ring: { name:'HP Ring',      nameEn:'Health Ring',     icon:'💍', slot:'acc',    atk:0,  def:0,  maxHp:20,  value:40,  buyable:true,  rarity:'uncommon'  },
  magic_ring:  { name:'Magic Ring',   nameEn:'Magic Ring',      icon:'🔮', slot:'acc',    atk:0,  def:0,  maxMp:15,  value:45,  buyable:true,  rarity:'rare'      },
  potion:      { name:'HP Potion',    nameEn:'Health Potion',   icon:'🧪', slot:null,     hp:40,                     value:20,  buyable:true,  rarity:'common'    },
  elixir:      { name:'Elixir',       nameEn:'Elixir',          icon:'✨', slot:null,     hp:80,  mp:20,             value:65,  buyable:true,  rarity:'rare'      },
  battle_brew: { name:'Battle Brew',  nameEn:'Battle Brew',     icon:'⚗', slot:null,     buffAtk:10, buffLeft:3,    value:45,  buyable:true,  rarity:'uncommon'  },
  shadow_blade:{ name:'Shadow Blade', nameEn:'Shadow Blade',    icon:'🌑', slot:'weapon', atk:18, def:0,             value:280, buyable:false, rarity:'epic'      },
  thorn_shield: { name:'Thorn Shield',  nameEn:'Thorn Shield',  icon:'🌵', slot:'armor',  atk:3,  def:12,                       value:150, buyable:false, rarity:'rare'      },
  ...
  mp_rune:      { name:'MP-Rune',     nameEn:'MP Rune',         icon:'🟣', slot:'rune',   maxMp:18,                             value:90,  buyable:true,  rarity:'uncommon'  },
  void_rune:    { name:'Void-Rune',   nameEn:'Void Rune',       icon:'⚫', slot:'rune',   atk:12, critBonus:0.05,               value:200, buyable:false, rarity:'epic'      },
  wind_rune:    { name:'Wind-Rune',   nameEn:'Wind Rune',       icon:'🌀', slot:'rune',   atk:6,  def:6,                        value:180, buyable:false, rarity:'epic'      },
  // Helm
  leather_helm: { name:'Leder-Helm',      nameEn:'Leather Helm',      icon:'🪖', slot:'helm',   def:4,           value:50,  buyable:true,  rarity:'common'    },
  iron_helm:    { name:'Eisen-Helm',       nameEn:'Iron Helm',         icon:'⛑',  slot:'helm',   def:8,  atk:2,   value:140, buyable:true,  rarity:'uncommon'  },
  shadow_helm:  { name:'Schatten-Helm',    nameEn:'Shadow Helm',       icon:'🎭', slot:'helm',   def:12, atk:5,   value:420, buyable:false, rarity:'rare'      },
  // Gloves
  iron_gloves:  { name:'Eisen-Handschuhe',nameEn:'Iron Gauntlets',     icon:'🧤', slot:'gloves', atk:5,           value:60,  buyable:true,  rarity:'common'    },
  magic_gloves: { name:'Magie-Handschuhe',nameEn:'Magic Gloves',       icon:'✋',  slot:'gloves', atk:7,  maxMp:12,value:160, buyable:true,  rarity:'uncommon'  },
  void_gloves:  { name:'Void-Handschuhe', nameEn:'Void Gloves',        icon:'🖐',  slot:'gloves', atk:14, critBonus:0.10, value:900, buyable:false, rarity:'legendary' },
  // Boots
  leather_boots:{ name:'Leder-Stiefel',   nameEn:'Leather Boots',      icon:'👢', slot:'boots',  def:3,           value:55,  buyable:true,  rarity:'common'    },
  swift_boots:  { name:'Schnelle Stiefel', nameEn:'Swift Boots',        icon:'👟', slot:'boots',  def:5,  maxMp:8, value:150, buyable:true,  rarity:'uncommon'  },
  void_boots:   { name:'Void-Stiefel',     nameEn:'Void Boots',         icon:'🥾', slot:'boots',  def:10, atk:6,   value:750, buyable:false, rarity:'epic'      },
  // New weapons
  iron_axe:     { name:'Eisen-Axt',        nameEn:'Iron Axe',           icon:'🪓', slot:'weapon', wType:'axe',   atk:14, def:2,         value:180, buyable:true,  rarity:'uncommon'  },
  hunter_bow:   { name:'Jäger-Bogen',       nameEn:'Hunter Bow',        icon:'🏹', slot:'weapon', wType:'bow',   atk:12,                value:200, buyable:true,  rarity:'uncommon'  },
  mystic_staff: { name:'Mystischer Stab',   nameEn:'Mystic Staff',      icon:'🪄', slot:'weapon', wType:'staff', atk:10, maxMp:25, mpRegen:5, value:320, buyable:true, rarity:'rare' },
  // Resistance & utility
  resist_ring:  { name:'Widerstandsring',   nameEn:'Resist Ring',       icon:'💠', slot:'acc',    def:4, resist:0.30,            value:380, buyable:true,  rarity:'rare'      },
  // Resources (consumable-like, tracked in G.resources)
  wood:         { name:'Holz',              nameEn:'Wood',               icon:'🪵', slot:null, qty:0,                             value:5,   buyable:false, rarity:'common'    },
  ore:          { name:'Erz',               nameEn:'Ore',                icon:'🪨', slot:null, qty:0,                             value:8,   buyable:false, rarity:'common'    },
  herbs:        { name:'Kräuter',           nameEn:'Herbs',              icon:'🌿', slot:null, qty:0,                             value:6,   buyable:false, rarity:'common'    },
  // Scroll
  id_scroll:    { name:'Identifizierungs-Schriftrolle', nameEn:'Identify Scroll', icon:'📜', slot:null, hp:0,                  value:50,  buyable:true,  rarity:'uncommon'  },
  // Cooking results
  strength_brew: { name:'Stärke-Sud', nameEn:'Strength Brew',           icon:'🍵', slot:null, buffAtk:15, buffLeft:5, value:60, buyable:false, rarity:'uncommon' },
  big_potion:    { name:'Großer Heiltrank', nameEn:'Big Potion',         icon:'🧴', slot:null, hp:80, value:45, buyable:false, rarity:'uncommon' },
  roasted_herb:  { name:'Gebratenes Kraut', nameEn:'Roasted Herb',       icon:'🍃', slot:null, buffDef:8, buffLeft:4, value:35, buyable:false, rarity:'common' },
  // Fishing
  fish:          { name:'Fisch',          nameEn:'Fish',                 icon:'🐟', slot:null, hp:30, value:15, buyable:false, rarity:'common' },
  rare_fish:     { name:'Seltener Fisch', nameEn:'Rare Fish',            icon:'🐠', slot:null, hp:0,  value:90, buyable:false, rarity:'rare'   },
  // Artifact
  soul_gem: { name:'Seelen-Stein', nameEn:'Soul Gem',                    icon:'💎', slot:'acc', atk:2, def:2, artifact:true, value:600, buyable:false, rarity:'legendary' },
  // ── NEW WEAPONS ─────────────────────────────────────────────
  bone_dagger:    { name:'Knochendolch',      nameEn:'Bone Dagger',      icon:'🗡', slot:'weapon', wType:'dagger', atk:8,  critBonus:0.12,               value:90,   buyable:false, rarity:'uncommon'  },
  runed_sword:    { name:'Runenschwert',       nameEn:'Runed Sword',      icon:'⚔', slot:'weapon', atk:16, critBonus:0.08,                               value:260,  buyable:true,  rarity:'rare'      },
  berserker_axe:  { name:'Berserker-Axt',      nameEn:'Berserker Axe',   icon:'🪓', slot:'weapon', wType:'axe',  atk:26, def:-3,                       value:480,  buyable:false, rarity:'epic'      },
  plague_scythe:  { name:'Pest-Sense',         nameEn:'Plague Scythe',   icon:'⚔', slot:'weapon', atk:20,                                              value:520,  buyable:false, rarity:'epic'      },
  cursed_blade:   { name:'Verfluchte Klinge',  nameEn:'Cursed Blade',    icon:'🌑', slot:'weapon', atk:22, lifesteal:0.18,                              value:580,  buyable:false, rarity:'epic'      },
  celestial_bow:  { name:'Himmels-Bogen',      nameEn:'Celestial Bow',   icon:'🏹', slot:'weapon', wType:'bow',  atk:35,                               value:1200, buyable:false, rarity:'legendary' },
  poison_fang:    { name:'Giftfang',           nameEn:'Poison Fang',     icon:'🦷', slot:'weapon', atk:6,                                              value:120,  buyable:false, rarity:'uncommon'  },
  // ── NEW ARMOR ───────────────────────────────────────────────
  chain_mail:     { name:'Kettenhemd',         nameEn:'Chain Mail',      icon:'🔗', slot:'armor',  atk:0,  def:7,                                      value:110,  buyable:true,  rarity:'uncommon'  },
  mage_robe:      { name:'Magiermantel',       nameEn:'Mage Robe',       icon:'👘', slot:'armor',  atk:0,  def:5,  maxMp:20,                           value:140,  buyable:true,  rarity:'uncommon'  },
  dragon_scale:   { name:'Drachenschuppe',     nameEn:'Dragon Scale',    icon:'🔴', slot:'armor',  atk:0,  def:30, maxHp:20,                           value:1100, buyable:false, rarity:'legendary' },
  berserker_plate:{ name:'Berserker-Platte',   nameEn:'Berserker Plate', icon:'⚫', slot:'armor',  atk:8,  def:16,                                    value:600,  buyable:false, rarity:'epic'      },
  // ── NEW ACCESSORIES ─────────────────────────────────────────
  speed_ring:     { name:'Schnelligkeitsring', nameEn:'Speed Ring',      icon:'💠', slot:'acc',   evasion:0.12,                                        value:220,  buyable:true,  rarity:'rare'      },
  mana_crystal:   { name:'Mana-Kristall',      nameEn:'Mana Crystal',    icon:'🔷', slot:'acc',   maxMp:40,                                            value:280,  buyable:true,  rarity:'rare'      },
  blood_pendant:  { name:'Blut-Amulett',       nameEn:'Blood Pendant',   icon:'🔴', slot:'acc',   lifesteal:0.12,                                      value:450,  buyable:false, rarity:'epic'      },
  battle_medallion:{ name:'Kampf-Medaillon',   nameEn:'Battle Medallion',icon:'🏅', slot:'acc',   atk:8,  critBonus:0.05,                              value:380,  buyable:true,  rarity:'rare'      },
  // ── NEW HELMETS ─────────────────────────────────────────────
  horned_helm:    { name:'Gehörnter Helm',     nameEn:'Horned Helm',     icon:'🪖', slot:'helm',  atk:6,  def:6,                                       value:280,  buyable:false, rarity:'rare'      },
  crystal_crown:  { name:'Kristallkrone',      nameEn:'Crystal Crown',   icon:'👑', slot:'helm',  def:10, maxMp:30, critBonus:0.07,                    value:750,  buyable:false, rarity:'legendary' },
  // ── NEW GLOVES ──────────────────────────────────────────────
  claw_gauntlets: { name:'Klauenhandschuhe',   nameEn:'Claw Gauntlets',  icon:'🧤', slot:'gloves',atk:8,  critBonus:0.12,                              value:320,  buyable:false, rarity:'rare'      },
  battle_gauntlets:{ name:'Kampfhandschuhe',   nameEn:'Battle Gauntlets',icon:'🥊', slot:'gloves',atk:10, def:3,                                      value:200,  buyable:true,  rarity:'uncommon'  },
  // ── NEW BOOTS ───────────────────────────────────────────────
  shadow_boots:   { name:'Schattenstiefel',    nameEn:'Shadow Boots',    icon:'👟', slot:'boots', def:6,  evasion:0.10,                               value:280,  buyable:false, rarity:'rare'      },
  storm_boots:    { name:'Sturmstiefel',       nameEn:'Storm Boots',     icon:'⚡', slot:'boots', def:4,  maxMp:15,                                   value:160,  buyable:true,  rarity:'uncommon'  },
  // ── NEW CONSUMABLES ─────────────────────────────────────────
  mega_potion:    { name:'Mega-Trank',         nameEn:'Mega Potion',     icon:'🧪', slot:null,    hp:150,                                              value:120,  buyable:false, rarity:'rare'      },
  mp_potion:      { name:'Mana-Trank',         nameEn:'Mana Potion',     icon:'💧', slot:null,    mp:50,                                               value:60,   buyable:true,  rarity:'uncommon'  },
  revive_gem:     { name:'Wiederbelebungsstein',nameEn:'Revival Stone',   icon:'💎', slot:null,   hp:999, mp:999,                                      value:200,  buyable:true,  rarity:'rare'      },
  // ── HIGH-LEVEL WEAPONS (level 50+) ──────────────────────────
  abyssal_blade:  { name:'Abyssale Klinge',    nameEn:'Abyssal Blade',   icon:'⚔', slot:'weapon', atk:45, critBonus:0.12,                              value:1800, buyable:false, rarity:'legendary' },
  storm_lance:    { name:'Sturmlanze',          nameEn:'Storm Lance',     icon:'⚡', slot:'weapon', atk:40, def:5,                                      value:1400, buyable:true,  rarity:'epic'      },
  frost_spear:    { name:'Frostspeer',          nameEn:'Frost Spear',     icon:'❄', slot:'weapon', atk:38, def:0,                                      value:1300, buyable:true,  rarity:'epic'      },
  void_scythe:    { name:'Leeren-Sense',        nameEn:'Void Scythe',     icon:'🌀', slot:'weapon', atk:52, lifesteal:0.15,                             value:2200, buyable:false, rarity:'legendary' },
  // ── HIGH-LEVEL ARMOR (level 50+) ────────────────────────────
  abyssal_plate:  { name:'Abyssale Platte',     nameEn:'Abyssal Plate',   icon:'🔵', slot:'armor',  atk:0,  def:35, maxHp:30,                          value:1600, buyable:false, rarity:'legendary' },
  storm_mail:     { name:'Sturmrüstung',         nameEn:'Storm Mail',      icon:'⛅', slot:'armor',  atk:0,  def:28, maxMp:20,                          value:1200, buyable:true,  rarity:'epic'      },
  frost_cloak:    { name:'Frostmantel',          nameEn:'Frost Cloak',     icon:'🧊', slot:'armor',  atk:0,  def:30, resist:0.20,                       value:1350, buyable:true,  rarity:'epic'      },
  // ── HIGH-LEVEL ACCESSORIES (level 50+) ──────────────────────
  void_pendant:   { name:'Leeren-Amulett',      nameEn:'Void Pendant',    icon:'🌑', slot:'acc',    atk:12, critBonus:0.10, maxMp:25,                  value:1500, buyable:false, rarity:'legendary' },
  storm_ring:     { name:'Sturmring',            nameEn:'Storm Ring',      icon:'⚡', slot:'acc',    atk:10, evasion:0.10,                              value:950,  buyable:true,  rarity:'epic'      },
  frost_heart:    { name:'Frostherz',            nameEn:'Frost Heart',     icon:'💙', slot:'acc',    def:10, maxHp:50, resist:0.15,                     value:1100, buyable:true,  rarity:'epic'      },
};
...
// ── CRAFTING ─────────────────────────────────────────────────
const CRAFTING = [
  { id:'c_elixir',  label:'Elixier brauen',   labelEn:'Brew Elixir',                          requires:[{id:'potion',qty:3}],                                  result:'elixir',       resultQty:1 },
  { id:'c_brew',    label:'Battle Brew ×2',    labelEn:'Battle Brew ×2',                       requires:[{id:'elixir',qty:2}],                                  result:'battle_brew',  resultQty:2 },
  { id:'c_crystal', label:'Chaos-Kristall',    labelEn:'Chaos Crystal',                        requires:[{id:'magic_ring',qty:1},{id:'health_ring',qty:1}],     result:'chaos_crystal',resultQty:1 },
  { id:'c_chaos',   label:'Chaos-Klinge',      labelEn:'Chaos Blade',                          requires:[{id:'dragon_blade',qty:1},{id:'shadow_blade',qty:1}],  result:'chaos_blade',  resultQty:1 },
  { id:'c_void',    label:'Void-Robe',         labelEn:'Void Robe',                            requires:[{id:'demon_armor',qty:1},{id:'thorn_shield',qty:1}],   result:'void_robe',    resultQty:1 },
  { id:'c_herb_pot',label:'Heiltrank ×2 (Kräuter)', labelEn:'Health Potion ×2 (Herbs)',       requires:[{id:'herbs',qty:3,res:true}],                          result:'potion',       resultQty:2, resReq:true },
  { id:'c_ore_shld',label:'Erz-Schild (Erz)',  labelEn:'Ore Shield (Ore)',                     requires:[{id:'ore',qty:5,res:true}],                            result:'iron_shield',  resultQty:1, resReq:true },
  { id:'c_wood_bow',label:'Holzbogen (Holz)',   labelEn:'Wood Bow (Wood)',                      requires:[{id:'wood',qty:6,res:true}],                           result:'hunter_bow',   resultQty:1, resReq:true },
  { id:'ck_strength', label:'🍵 Stärke-Sud (Kräuter+Erz)',      labelEn:'🍵 Strength Brew (Herbs+Ore)',    requires:[{id:'herbs',qty:2,res:true},{id:'ore',qty:1,res:true}],                  result:'strength_brew', resultQty:1, resReq:true },
  { id:'ck_bigpot',   label:'🧴 Großer Trank (Kräuter+Holz)',   labelEn:'🧴 Big Potion (Herbs+Wood)',      requires:[{id:'herbs',qty:3,res:true},{id:'wood',qty:2,res:true}],                 result:'big_potion',    resultQty:1, resReq:true },
  { id:'ck_roast',    label:'🍃 Geröstetes Kraut (Kräuter×4)',  labelEn:'🍃 Roasted Herb (Herbs×4)',       requires:[{id:'herbs',qty:4,res:true}],                                            result:'roasted_herb',  resultQty:2, resReq:true },
  { id:'ck_mpotion',  label:'💧 Mana-Trank ×2 (Kräuter×2)',    labelEn:'💧 Mana Potion ×2 (Herbs×2)',    requires:[{id:'herbs',qty:2,res:true}],                                            result:'mp_potion',     resultQty:2, resReq:true },
  { id:'ck_mega',     label:'🧪 Mega-Trank (Trank×3+Kräuter)', labelEn:'🧪 Mega Potion (Potion×3+Herbs)',requires:[{id:'potion',qty:3},{id:'herbs',qty:2,res:true}],                         result:'mega_potion',   resultQty:1, resReq:true },
  { id:'c_revive',    label:'💎 Wiederbelebungsstein (Kristall+Elixier)', labelEn:'💎 Revival Stone (Crystal+Elixir)', requires:[{id:'chaos_crystal',qty:1},{id:'elixir',qty:2}],            result:'revive_gem',    resultQty:1 },
  { id:'c_steel_sword', label:'⚔ Stahl-Schwert (Erz×8)',           labelEn:'⚔ Steel Sword (Ore×8)',            requires:[{id:'ore',qty:8,res:true}],                                      result:'iron_sword',  resultQty:1, resReq:true },
  { id:'c_chain',       label:'🛡 Kettenrüstung (Erz×6+Holz×3)',   labelEn:'🛡 Chain Mail (Ore×6+Wood×3)',     requires:[{id:'ore',qty:6,res:true},{id:'wood',qty:3,res:true}],            result:'chain_mail',  resultQty:1, resReq:true },
  { id:'c_atk_rune',    label:'💎 ATK-Rune (Erz×4+Kräuter×2)',     labelEn:'💎 ATK Rune (Ore×4+Herbs×2)',      requires:[{id:'ore',qty:4,res:true},{id:'herbs',qty:2,res:true}],           result:'atk_rune',    resultQty:1, resReq:true },
  { id:'c_def_rune',    label:'🛡 DEF-Rune (Erz×3+Holz×3)',        labelEn:'🛡 DEF Rune (Ore×3+Wood×3)',       requires:[{id:'ore',qty:3,res:true},{id:'wood',qty:3,res:true}],            result:'def_rune',    resultQty:1, resReq:true },
  { id:'c_storm_boots', label:'👢 Sturm-Stiefel (Erz×5+Holz×4)',   labelEn:'👢 Storm Boots (Ore×5+Wood×4)',    requires:[{id:'ore',qty:5,res:true},{id:'wood',qty:4,res:true}],            result:'storm_boots', resultQty:1, resReq:true },
  { id:'c_battle_helm', label:'🪖 Kampf-Helm (Erz×6+Kräuter×3)',   labelEn:'🪖 Battle Helm (Ore×6+Herbs×3)',  requires:[{id:'ore',qty:6,res:true},{id:'herbs',qty:3,res:true}],           result:'shadow_helm', resultQty:1, resReq:true },
  { id:'c_mana_pot',    label:'💧 Mana-Kristall (Kräuter×5+Erz×2)',labelEn:'💧 Mana Crystal (Herbs×5+Ore×2)', requires:[{id:'herbs',qty:5,res:true},{id:'ore',qty:2,res:true}],           result:'mana_crystal',resultQty:1, resReq:true },
];
...
// ── QUESTS ──────────────────────────────────────────────────
const QUEST_POOL = [
  {type:'kill',target:'rat',      qty:5,  label:'Töte 5 Ratten',       labelEn:'Kill 5 Rats',            xpR:40,  goldR:25},
  {type:'kill',target:'slime',    qty:5,  label:'Töte 5 Slimes',       labelEn:'Kill 5 Slimes',           xpR:50,  goldR:30},
  {type:'kill',target:'goblin',   qty:5,  label:'Töte 5 Goblins',      labelEn:'Kill 5 Goblins',          xpR:80,  goldR:50},
  {type:'kill',target:'bat',      qty:5,  label:'Töte 5 Fledermäuse',  labelEn:'Kill 5 Bats',             xpR:70,  goldR:45},
  {type:'kill',target:'wolf',     qty:3,  label:'Töte 3 Wölfe',        labelEn:'Kill 3 Wolves',           xpR:80,  goldR:55},
  {type:'kill',target:'troll',    qty:3,  label:'Töte 3 Trolle',       labelEn:'Kill 3 Trolls',           xpR:130, goldR:90},
  {type:'kill',target:'skeleton', qty:3,  label:'Töte 3 Skelette',     labelEn:'Kill 3 Skeletons',        xpR:120, goldR:80},
  {type:'kill',target:'zombie',   qty:3,  label:'Töte 3 Zombies',      labelEn:'Kill 3 Zombies',          xpR:140, goldR:90},
  {type:'kill',target:'ghost',    qty:3,  label:'Töte 3 Geister',      labelEn:'Kill 3 Ghosts',           xpR:160, goldR:100},
  {type:'kill',target:'demon',    qty:2,  label:'Töte 2 Dämonen',      labelEn:'Kill 2 Demons',           xpR:200, goldR:150},
  {type:'kill',target:'dragon',   qty:1,  label:'Besiege den Drachen', labelEn:'Defeat the Dragon',       xpR:350, goldR:250},
  {type:'step',qty:15,  label:'Gehe 15 Schritte',  labelEn:'Take 15 steps',           xpR:35,  goldR:20},
  {type:'step',qty:30,  label:'Gehe 30 Schritte',  labelEn:'Take 30 steps',           xpR:70,  goldR:40},
  {type:'step',qty:60,  label:'Gehe 60 Schritte',  labelEn:'Walk 60 steps',           xpR:130, goldR:75},
  {type:'step',qty:100, label:'Gehe 100 Schritte', labelEn:'Walk 100 steps',          xpR:200, goldR:120, itemR:'potion'},
  {type:'gold',qty:80,  label:'Verdiene 80 Gold',  labelEn:'Earn 80 Gold',            xpR:55,  goldR:0,   itemR:'potion'},
  {type:'gold',qty:200, label:'Verdiene 200 Gold', labelEn:'Earn 200 Gold',           xpR:120, goldR:0,   itemR:'elixir'},
  {type:'craft',qty:3,  label:'Stelle 3 Items her', labelEn:'Craft 3 items',          xpR:90,  goldR:60},
  {type:'craft',qty:5,  label:'Stelle 5 Items her', labelEn:'Craft 5 items',          xpR:150, goldR:100, itemR:'potion'},
  {type:'survive',qty:10, label:'Überlebe 10 Kampfrunden', labelEn:'Survive 10 combat rounds', xpR:80,  goldR:50},
  {type:'survive',qty:25, label:'Überlebe 25 Kampfrunden', labelEn:'Survive 25 combat rounds', xpR:160, goldR:100, itemR:'elixir'},
];

const DAILY_POOL = [
  {type:'kill',target:'any',qty:8,  label:'Besiege 8 Gegner',      labelEn:'Defeat 8 enemies',   xpR:120, goldR:80},
  {type:'kill',target:'any',qty:15, label:'Besiege 15 Gegner',     labelEn:'Defeat 15 enemies',  xpR:200, goldR:140},
  {type:'step',qty:20,              label:'Gehe 20 Schritte',       labelEn:'Take 20 steps',      xpR:80,  goldR:60},
  {type:'step',qty:40,              label:'Gehe 40 Schritte',       labelEn:'Walk 40 steps',      xpR:160, goldR:100},
  {type:'gold',qty:100,             label:'Verdiene 100 Gold',      labelEn:'Earn 100 Gold',      xpR:100, goldR:0, itemR:'elixir'},
  {type:'gold',qty:300,             label:'Verdiene 300 Gold',      labelEn:'Earn 300 Gold',      xpR:180, goldR:0, itemR:'elixir'},
  {type:'kill',target:'goblin',qty:3,label:'Töte 3 Goblins',       labelEn:'Kill 3 Goblins',     xpR:90,  goldR:70},
  {type:'kill',target:'skeleton',qty:2,label:'Töte 2 Skelette',    labelEn:'Kill 2 Skeletons',   xpR:100, goldR:80},
];
